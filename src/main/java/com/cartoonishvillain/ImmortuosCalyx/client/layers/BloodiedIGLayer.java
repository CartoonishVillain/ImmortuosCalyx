...
public class BloodiedIGLayer extends RenderLayer<InfectedIGEntity, IronGolemModel<InfectedIGEntity>> {
    protected final static ResourceLocation TEXTURE = new ResourceLocation(ImmortuosCalyx.MOD_ID, "textures/entity/base_golem.png");

    public BloodiedIGLayer(RenderLayerParent<InfectedIGEntity, IronGolemModel<InfectedIGEntity>> entityRendererIn) {
