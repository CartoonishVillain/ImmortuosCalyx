...
public class Register {
    ...
    public static final RegistryObject<Item> UNSTABLESTRAND = ITEMS.register("unstablestrand", () -> new BaseItems(new Item.Properties().tab(ImmortuosCalyx.TAB),ChatFormatting.BLUE + "Rare drop from heavily infected individuals", ChatFormatting.BLUE + "Can be refined into a more stable state"));
    public static final RegistryObject<Item> STABLIZEDSTRAND = ITEMS.register("stablizedstrand", () -> new BaseItems(new Item.Properties().tab(ImmortuosCalyx.TAB).stacksTo(1),ChatFormatting.BLUE + "Can be injected into a player to impede", ChatFormatting.BLUE + "infection progress, allowing you to keep effects", ChatFormatting.BLUE + "without being fully converted."));
