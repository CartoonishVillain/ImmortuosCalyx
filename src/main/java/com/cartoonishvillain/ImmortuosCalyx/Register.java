...
public class Register {
    ...
    public static final RegistryObject<Item> CALYXANIDE = ITEMS.register("calyxanide", () -> new BaseItems(new Item.Properties().tab(ImmortuosCalyx.TAB),TextFormatting.BLUE + "Kills the Immortuos Calyx Parasite", TextFormatting.BLUE + "May need multiple doses for later stage infections", TextFormatting.RED + "May be lethal if the parasite is ingrained too heavily", ""));
    public static final RegistryObject<Item> GENERALANTIPARASITIC = ITEMS.register("antiparasitic", () -> new BaseItems(new Item.Properties().tab(ImmortuosCalyx.TAB),TextFormatting.BLUE + "Strengthens Immune System to the Immortuos Calyx Parasite", TextFormatting.BLUE + "Does not make you immune. May also kill early forms of infection", TextFormatting.RED + "Will cause light organ damage", TextFormatting.GRAY + "Obtained through syringe extraction from a slime"));
    public static final RegistryObject<Item> IMMORTUOSCALYXEGGS = ITEMS.register("immortuoseggs", () -> new BaseItems(new Item.Properties().tab(ImmortuosCalyx.TAB),TextFormatting.RED + "Infects humans with the Immortuos Calyx Parasite,", TextFormatting.GRAY + "Obtained through syringe extraction from fully converted entities", "", ""));
    public static final RegistryObject<Item> SYRINGE = ITEMS.register("syringe", () -> new BaseItems(new Item.Properties().tab(ImmortuosCalyx.TAB),TextFormatting.GRAY + "Allows you to harvest biomaterials necessary to make medicines", "", "", ""));
    public static final RegistryObject<Item> SCANNER = ITEMS.register("healthscanner", () -> new BaseItems(new Item.Properties().tab(ImmortuosCalyx.TAB).stacksTo(1),TextFormatting.BLUE + "Gives you information about infection", TextFormatting.BLUE + "levels in players, and yourself.",TextFormatting.GRAY + "Shift rightclick to view your stats,", TextFormatting.GRAY + "left click players to view theirs."));
