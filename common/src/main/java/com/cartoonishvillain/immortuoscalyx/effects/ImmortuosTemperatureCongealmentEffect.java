...
public class ImmortuosTemperatureCongealmentEffect extends MobEffect implements ImmortuosEffect {

    public ImmortuosTemperatureCongealmentEffect(MobEffectCategory pCategory, int pColor) {
    ...
    public boolean applyEffectTick(LivingEntity pLivingEntity, int pAmplifier) {
        ...
        if (!pLivingEntity.level().isClientSide && (pLivingEntity.tickCount % 100 == 0)) {
            ...
            if (temperature < 0.5f) {
                pLivingEntity.addEffect(
                        new MobEffectInstance(
                                Services.PLATFORM.INFECTION_STRENGTH(),
                                120,
                                1,
                                true,
                                false,
                ...
                pLivingEntity.addEffect(
                        new MobEffectInstance(
                                Services.PLATFORM.INFECTION_RESIST(),
                                120,
                                1,
                                true,
                                false,
            ...
            if (temperature > 0.9f && !pLivingEntity.isInWaterRainOrBubble()) {
                pLivingEntity.addEffect(
                        new MobEffectInstance(
                                Services.PLATFORM.INFECTION_WEAKEN(),
                                120,
                                1,
                                true,
                                false,
                ...
                pLivingEntity.addEffect(
                        new MobEffectInstance(
                                Services.PLATFORM.INFECTION_VULNERABLE(),
                                120,
                                1,
                                true,
                                false,
