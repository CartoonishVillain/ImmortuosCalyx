...
public class DarkPlayerLayer extends RenderLayer<InfectedHumanEntity, HumanoidModel<InfectedHumanEntity>> {
    protected final static ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/entity/darkenedskin.png");

    public DarkPlayerLayer(RenderLayerParent<InfectedHumanEntity, HumanoidModel<InfectedHumanEntity>> entityRendererIn) {
