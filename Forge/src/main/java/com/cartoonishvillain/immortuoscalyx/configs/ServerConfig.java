...
public class ServerConfig {
    ...
    public ConfigHelper.ConfigValueListener<Integer> EFFECTIMPEDIMENT;
    ...
    public ServerConfig(ForgeConfigSpec.Builder builder, ConfigHelper.Subscriber subscriber){
        ...
        this.EFFECTIMPEDIMENT = subscriber.subscribe(builder.comment("Changes when players will stop gaining infection when injected with a stablized sample.").defineInRange("effectImpedimentTime", 89, 0, Integer.MAX_VALUE));
        builder.pop();
