...
public class ImmortuosSpawnEggItem extends SpawnEggItem {
    ...
    public ImmortuosSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColorIn, final int secondaryColorIn, final Properties properties) {
